...
$query = mysqli_query($koneksi, "SELECT * FROM makanan WHERE id_produk = '$id_produk'");
$data = mysqli_fetch_array($query);
$stock = $_GET['jumlah'];
if (!isset($_SESSION['masuk'])) {
    echo "<script>alert('Anda harus login untuk memesan makanan ini!'); window.location = 'login.php'</script>";
    ...
    echo "<script>alert('Anda belum memilih makanan!'); window.location = 'produk.php'</script>";
} else {
