...
<h3> <span class="glyphicon glyphicon-briefcase"></span> Konfirmasi Menu telah Sampai</h3>
...
$query = mysqli_query($koneksi, 'SELECT PS.id_pemesanan, P.nama as nama_barang, U.nama as nama_pemesan, PS.jumlah, PS.total_harga, PS.status 
	FROM makanan P INNER JOIN (PEMESANAN PS INNER JOIN USERS U ON U.id_user = PS.id_user)
